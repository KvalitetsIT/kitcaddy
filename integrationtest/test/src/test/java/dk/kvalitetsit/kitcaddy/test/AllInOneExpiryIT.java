...
public class AllInOneExpiryIT extends AbstractAllInOneIT {
	...
	@Test
	public void testSamlSpSessionExpiryTriggersNewLogin() throws JSONException, JsonMappingException, JsonProcessingException {
	...
	@Test
	public void testWscSessionExpiryIsHandledTransparently() throws JSONException, JsonMappingException, JsonProcessingException {
	...
	private Response resultAfterExpiry(Expiry expiry) throws JSONException, JsonMappingException, JsonProcessingException {
		// Perform login
		String username = UUID.randomUUID().toString();
		String password = "secret1234";
		addUserToKeycloak(username, password);
		RemoteWebDriver webdriver = chrome.getWebDriver();
		String url = "http://"+SAML_SP_URL+"/service/test";
		String resultBeforeExpiry = doLoginFlow(webdriver, url, username, password);
	...
	private JsonNode parseJsonReturned(String result) throws JsonMappingException, JsonProcessingException {
